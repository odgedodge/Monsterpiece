dialogue_dracula = {
    ...
    "dialogue one": ["You need to be careful Henry, life and death is not to be meddled with.", "If you're sure you will be careful, do not make the same mistakes again.", "If he is rebuilt, it should be as a mememnto, a warning to not meddle outside the human domain."],
