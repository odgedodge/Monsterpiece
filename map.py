...
dripping sound a source of dread.""", {"south": "Basement"}, [item_saw, item_hammer, item_soul_jar], None)

room_attic = Room("Attic", """The attic sits eerily, memories stashed away with nowhere to go. The room is cloaked in a half-light, with the weak glow of 
...
decorations show a history of this house being a home, before every ounce of hope was pushed out.""", {"west": "Bedroom"}, [item_chucky, item_right_arm], None)

room_bedroom = Room("Master Bedroom", """The bedroom exudes an aura of lingering malevolence, trapped within its timeworn walls. Moonlight seeps through moth-eaten
...
revealing glimpses of a long forgotten floral pattern, and the windows rattle softly in the frosty wind.""", {"down": "Entrance", "east": "Attic"}, [item_needle_and_thread], dracula)

room_kitchen = Room("Kitchen", """You enter the kitchen, its once-vibrant yellow walls now faded and peeling. The air is thick with an eerie stillness, 
...
every step uneasy as you explore the space.""", {"north": "Entrance", "east": "Garden", "west": "Basement"}, [item_holy_water], None)

room_theatre = Room("Theatre", """You step into the old theatre, a grand space frozen in time. The scent of aged velvet and polished wood mingles with a 
...
grand, cobweb-covered chandelier hangs precariously above, its crystals refracting ghostly glimmers.""", {"east": "Entrance"}, [item_pizza], freddy)

room_entrance = Room("Entrance Hall", """You find yourself in the vast entrance room. Dim candle light flickers against the peeling wallpaper, casting unsettling
...
setting the stage for the mysteries that lie deeper within the building.""", {"north": "Library", "east": "Living Room", "south": "Kitchen", "west": "Theatre", "up": "Bedroom"}, [], None)

room_basement = Room("Basement", """The basement lies beneath the creaking floorboards, a realm of chilling darkness and unspeakable secrets. Descending 
...
and shattered relics, all covered in a layer of dust. """, {"east": "Kitchen", "north": "Lab"}, [], pennywise)

room_garden = Room("Garden", """The garden seems endless as you step outside, trees spanning the fence with weeds covering stone of the path. Ivy 
...
around on the far side of the garden you spot a tall, slender figure. """, {"west": "Kitchen"}, [item_rock], slenderman)

room_living_room = Room("Living Room", """You step into the living room, a once-grand space now draped in shadows. Tattered curtains sway gently, revealing 
...
melancholy lingers in the air, as if the room itself mourns its lost elegance.""", {"west": "Entrance"}, [item_spear], grim)

room_library = Room("Library", """In the library, ancient tomes line towering, dusty shelves that stretch from floor to ceiling. Dim candle light flickers,
...
and lingering, unsettling dread, as if the very essence of knowledge in the room is imbued with a dark energy. """, {"south": "Entrance"}, [item_instruction_book, item_eight_pages], None)
